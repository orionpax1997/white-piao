...
const createSourceTable = async () => {
  ...
  ${SOURCE_CONSTANTS.FIELDS.SEARCH_SCRIPT} ${TEXT_NULL_TYPE},
  ${SOURCE_CONSTANTS.FIELDS.FIND_SERIES_SCRIPT} ${TEXT_NULL_TYPE},
  ${SOURCE_CONSTANTS.FIELDS.FIND_STREAM_SCRIPT} ${TEXT_NULL_TYPE},
  ${SOURCE_CONSTANTS.FIELDS.FIND_DISCOVERY_SCRIPT} ${TEXT_NULL_TYPE},
  ${SOURCE_CONSTANTS.FIELDS.DISCOVERY_SCRIPT} ${TEXT_NULL_TYPE},
...
const dropDiscoveryTable = async () => {
  await execSql(`DROP TABLE IF EXISTS ${DISCOVERY_CONSTANTS.TABLE_NAME}`);
};

const createDiscoveryTable = async () => {
  await execSql(`CREATE TABLE ${DISCOVERY_CONSTANTS.TABLE_NAME} ( 
  ${DISCOVERY_CONSTANTS.IDENTIFIER} ${ID_TYPE}, 
  ${DISCOVERY_CONSTANTS.FIELDS.TITLE} ${TEXT_TYPE},
  ${DISCOVERY_CONSTANTS.FIELDS.DISCOVERY_URL} ${TEXT_TYPE},
  ${DISCOVERY_CONSTANTS.FIELDS.SOURCE_ID} ${INTEGER_TYPE}
  )`);
};
